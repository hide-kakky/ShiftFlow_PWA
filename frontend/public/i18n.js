...
(function (globalScope) {
    ...
    ja: {
      ...
      link_view_all: '一覧へ',
      btn_reload: '再読込',
      header_search_open: '検索を開く',
      header_search_close: '検索を閉じる',
      header_other_actions: 'その他の操作',
      header_user_menu: 'ユーザーメニュー',
      task_tab_my: 'あなたのタスク',
      task_tab_created: '依頼したタスク',
      task_tab_all: '全タスク',
      task_scope_my_short: '自分',
      task_scope_created_short: '依頼',
      task_scope_all_short: '全タスク',
      placeholder_keyword_search: 'キーワード検索',
      task_filter_assignee: '担当者で絞り込み',
      messages_filter_folder: 'フォルダ',
      messages_toolbar_label: 'メッセージの検索と絞り込み',
      messages_search_label: 'キーワード',
      filter_all: '全て',
